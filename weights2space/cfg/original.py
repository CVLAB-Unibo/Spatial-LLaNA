...
# TRAIN 
#
NUM_EPOCHS = 501    # original 501    
BATCH_SIZE = 2      # original 16 
...
GRID_RESOLUTION = 96
GRID_RESOLUTION_OBJANERF = 128
GRID_RESOLUTION_SHAPENERF = 96
GRID_CONFIG_N_SAMPLES = 1024

GRID_RECONSTRUCTION_TOTAL_ITERATIONS = 20
GRID_RECONSTRUCTION_WARMUP_ITERATIONS = 5
GRID_NUMBER_OF_CELLS = 884736 
GRID_NUMBER_OF_CELLS_OBJANERF = 2097152
GRID_NUMBER_OF_CELLS_SHAPENERF = 884736
...
NERF_WEIGHTS_FILE_NAME = 'nerf_weights.pth'  # OBJANERF 'ngp_24_3_64_10/nerf_weights.pth'    # SHAPENERF 'nerf_weights.pth'
NERF_WEIGHTS_FILE_NAME_OBJANERF = 'mlp_128/nerf_weights.pth'
NERF_WEIGHTS_FILE_NAME_SHAPENERF = 'nerf_weights.pth'
...
# ####################
"""
LEARNABLE_QUERY_DIM = 516      # original 3072  # new: 516
N_LEARNABLE_QUERY = 3072        # original 16 # new: 3072
QUERY_INIT_STD = 0.02           # from bert-base-uncased 
N_HEADS = 12
DIM_FEEDFORWARD = 2064         # original 12288 (for 16x3072 tokens) # new: 2064 (for 3072x516 tokens) # new: 1008 (for 3072x252 tokens)
N_LAYERS = 12
...
TRIPLANE_PARAMS = {
  "hidden_dim": 516,     # original 16 # new: 516
  "resolution": 32,      # original 32
  "mlp_hidden_dim": 64,
